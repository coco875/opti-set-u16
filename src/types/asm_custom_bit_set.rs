...
impl SetInt for AsmCustomBitSet {
    fn clear(&mut self) {
        ...
        unsafe {
            ...
            asm!(
                "pxor xmm0, xmm0",
                "2:",
                "movdqu [ {ptr} + {index:r} ], xmm0",
                "movdqu [ {ptr} + {index:r} + 16 ], xmm0",
                "movdqu [ {ptr} + {index:r} + 32 ], xmm0",
                "movdqu [ {ptr} + {index:r} + 48 ], xmm0",
                "movdqu [ {ptr} + {index:r} + 64 ], xmm0",
                "movdqu [ {ptr} + {index:r} + 80 ], xmm0",
                "movdqu [ {ptr} + {index:r} + 96 ], xmm0",
                "movdqu [ {ptr} + {index:r} + 112 ], xmm0",
                "add {index:r}, 128",
                "cmp {index:r}, 8192",
                "jb 2b",
    ...
    fn len(&self) -> usize {
        ...
        unsafe {
            ...
            asm!(
                "2:",
                "popcnt {tmp}, qword ptr [{ptr} + {index:r}*8]",
                "add {count}, {tmp}",
                "inc {index:r}",
                "cmp {index:r}, 1024",
                "jl 2b",
    ...
    fn union_with(&mut self, other: &Self) {
        ...
        unsafe {
            ...
            asm!(
                "2:",
                "movdqu xmm0, [{self_ptr} + {index:r}]",
                "movdqu xmm1, [{self_ptr} + {index:r} + 16]",
                "movdqu xmm2, [{self_ptr} + {index:r} + 32]",
                "movdqu xmm3, [{self_ptr} + {index:r} + 48]",
                "movdqu xmm4, [{self_ptr} + {index:r} + 64]",
                "movdqu xmm5, [{self_ptr} + {index:r} + 80]",
                "movdqu xmm6, [{self_ptr} + {index:r} + 96]",
                "movdqu xmm7, [{self_ptr} + {index:r} + 112]",
                "movdqu xmm8, [{other_ptr} + {index:r}]",
                "movdqu xmm9, [{other_ptr} + {index:r} + 16]",
                "movdqu xmm10, [{other_ptr} + {index:r} + 32]",
                "movdqu xmm11, [{other_ptr} + {index:r} + 48]",
                "movdqu xmm12, [{other_ptr} + {index:r} + 64]",
                "movdqu xmm13, [{other_ptr} + {index:r} + 80]",
                "movdqu xmm14, [{other_ptr} + {index:r} + 96]",
                "movdqu xmm15, [{other_ptr} + {index:r} + 112]",
                "por xmm0, xmm8",
                "por xmm1, xmm9",
                "por xmm2, xmm10",
                "por xmm3, xmm11",
                ...
                "por xmm6, xmm14",
                "por xmm7, xmm15",
                "movdqu [{self_ptr} + {index:r}], xmm0",
                "movdqu [{self_ptr} + {index:r} + 16], xmm1",
                "movdqu [{self_ptr} + {index:r} + 32], xmm2",
                "movdqu [{self_ptr} + {index:r} + 48], xmm3",
                "movdqu [{self_ptr} + {index:r} + 64], xmm4",
                "movdqu [{self_ptr} + {index:r} + 80], xmm5",
                "movdqu [{self_ptr} + {index:r} + 96], xmm6",
                "movdqu [{self_ptr} + {index:r} + 112], xmm7",
                "add {index:r}, 128",
                "cmp {index:r}, 8192",
                "jb 2b",
    ...
    fn difference_with(&mut self, other: &Self) {
        ...
        unsafe {
            ...
            asm!(
                ...
                "pandn xmm14, xmm6",
                "pandn xmm15, xmm7",
                "movdqu [{self_ptr} + {index:r}], xmm8",
                "movdqu [{self_ptr} + {index:r} + 16], xmm9",
                "movdqu [{self_ptr} + {index:r} + 32], xmm10",
                "movdqu [{self_ptr} + {index:r} + 48], xmm11",
                "movdqu [{self_ptr} + {index:r} + 64], xmm12",
                "movdqu [{self_ptr} + {index:r} + 80], xmm13",
                "movdqu [{self_ptr} + {index:r} + 96], xmm14",
                "movdqu [{self_ptr} + {index:r} + 112], xmm15",
                "add {index:r}, 128",
                "cmp {index:r}, 8192",
                "jb 2b",
                self_ptr = in(reg) self.bits.as_mut_ptr(),
